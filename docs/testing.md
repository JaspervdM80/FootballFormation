...
| `session.spec.js` | Staying signed in: the auth cookie carrying a real expiry rather than being a session cookie, and surviving a link followed in from another site |
