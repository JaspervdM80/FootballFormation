...
/// leaves the door open to a MAUI Blazor Hybrid host. Both are cookies, so a circuit's scope — created by /_blazor — has them too.
public sealed record RequestContext(string? SeasonCookie, string? TeamCookie)
{
