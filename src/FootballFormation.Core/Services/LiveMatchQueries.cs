...
/// it: the game with its periods. The clock does its arithmetic on them, a goal takes its minute
/// from the period being played, and a substitution moves a slot inside one.
/// </summary>
